...
- Home follows the same DOM and visual order: active lesson turns, current Queue context, then resurfacing and feeds. At 1180px and below the working spread stacks so lesson titles retain space. Paused/draft Threads do not appear or inflate readiness; locked/missing-material turns explain their actual state.
