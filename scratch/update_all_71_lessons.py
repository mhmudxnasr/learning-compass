...
# Detailed dictionary for all 71 lessons:
lesson_content = {
    # --- LEVEL 0: Orientation (7 lessons) ---
    "lesson_path_item_1786576305170_7ff12be7": { # What systems thinking is
        "why_learn": "Traditional reductionism isolates components and fails to explain emergent behavior in interconnected environments. Systems thinking provides the foundational paradigm to see wholes, relationships, and feedback structures rather than isolated static snapshots.",
        "why_now": "Before learning tools, stocks, flows, and simulation models, you need the overarching mental shift from linear event-oriented thinking to systemic structural inquiry.",
        "takeaway": "A clear operational definition of a system (elements, interconnections, and purpose/function) and the ability to distinguish systemic problems from simple mechanical failures."
    },
    "lesson_path_item_1786576305356_47bb5906": { # Bottlenecks
        "why_learn": "Flow through any multi-stage system is strictly constrained by its narrowest bottleneck (Theory of Constraints). Optimizing non-bottlenecks wastes resources and increases local inventory without improving systemic throughput.",
        "why_now": "Master constraints early so you can quickly identify the true rate-limiting factor in any workflow, pipeline, or operational system before trying to redesign it.",
        "takeaway": "How to locate the active constraint, subordinate all other processes to its pace, and elevate systemic capacity without accidental sub-optimization."
    },
    "lesson_path_item_1786576305547_76335f6a": { # Feedback loops
        "why_learn": "Systems are not one-way chains of cause and effect; their outputs loop back to influence future inputs. Feedback loops explain self-correction, momentum, runaway compounding, and chronic oscillations.",
        "why_now": "Understanding feedback is the essential conceptual bridge from static system definitions to dynamic behavior analysis over time.",
        "takeaway": "How to identify reinforcing (amplifying/compounding) and balancing (stabilizing/goal-seeking) feedback loops in everyday personal and organizational systems."
    },
    "lesson_path_item_1786576305705_a6597233": { # Leverage points
        ...
        "why_now": "Learning where to intervene early gives clear purpose and diagnostic direction to all subsequent diagramming, modeling, and analysis exercises.",
        "takeaway": "An introductory grasp of Donella Meadows' leverage hierarchy—distinguishing low-leverage parameter tweaks from high-leverage shifts in rules, information flows, and system goals."
    },
    "lesson_path_item_1786576305871_c89cb642": { # Second-order effects
        "why_learn": "Most decisions fail because decision-makers optimize only for immediate first-order payoffs while ignoring the delayed second- and third-order ripple effects that often negate the original benefit.",
        "why_now": "Establishes the habitual 'and then what?' cognitive discipline needed before analyzing complex multi-loop feedback systems.",
        "takeaway": "The cognitive habit of tracing cascading consequences across time and boundaries to anticipate unintended side effects before taking action."
    },
    "lesson_path_item_1786576306785_19cfee01": { # Modeling exercise (L0)
        "why_learn": "Systems thinking is a craft acquired through active diagramming and boundary selection, not passive theory reading.",
        "why_now": "Solidifies orientation concepts (purpose, elements, stocks, feedback, and delays) by mapping a tangible everyday system immediately.",
    ...
    "lesson_path_item_1786576306971_738dda8e": { # One real-world application (L0)
        "why_learn": "Diagnostic value is proven when systemic principles uncover a hidden constraint or misdiagnosed problem in real work or life.",
        "why_now": "Closes Level 0 by translating conceptual orientation into a grounded diagnostic insight on an active operational challenge.",
        "takeaway": "A documented diagnosis of a recurring personal or work problem showing how treating symptoms exacerbated the underlying structural issue."
    },

    # --- LEVEL 1: Foundations (10 lessons) ---
    "lesson_path_item_1786576307477_cca500e2": { # What counts as a system
        "why_learn": "Not every collection of parts is a system. Confusing a mere heap/collection (e.g., sand pile) with an integrated system (e.g., digestive tract, software pipeline) leads to flawed analytical methods.",
        "why_now": "Sets rigorous foundational criteria before decomposing components, boundaries, and mathematical relationships.",
    ...
    "lesson_path_item_1786576307701_852eaac7": { # Elements, relationships, and purpose
    ...
    "lesson_path_item_1786576307891_8aa20010": { # System boundaries
    ...
    "lesson_path_item_1786576308101_e41683f4": { # Structure versus events
    ...
    "lesson_path_item_1786576308278_1aefe328": { # Stocks and flows
    ...
    "lesson_path_item_1786576308492_efc01414": { # Patterns over time
    ...
    "lesson_path_item_1786576308721_80388df8": { # Mental models
    ...
    "lesson_path_item_1786576308937_57d9273a": { # Linear versus systemic causality
    ...
    "lesson_path_item_1786576309932_21993e58": { # Modeling exercise (L1)
    ...
    "lesson_path_item_1786576310148_3a99f8ad": { # One real-world application (L1)
    ...
    "lesson_path_item_1786576310761_e58449c5": { # Positive and negative feedback
    ...
    "lesson_path_item_1786576311017_328d1767": { # Reinforcing and balancing loops
    ...
    "lesson_path_item_1786576311221_c9aff6dd": { # Delays
    ...
    "lesson_path_item_1786576311628_ed7ef6a2": { # Nonlinear relationships
    ...
    "lesson_path_item_1786576311842_3031d6c2": { # Exponential growth
    ...
    "lesson_path_item_1786576312119_015b2779": { # Limits to growth
    ...
    "lesson_path_item_1786576312330_c622ba7e": { # Oscillation
    ...
    "lesson_path_item_1786576312587_703cd536": { # Overshoot and collapse
    ...
    "lesson_path_item_1786576312803_db058f86": { # Policy resistance (L2)
    ...
    "lesson_path_item_1786576314019_e07c80e6": { # Modeling exercise (L2)
    ...
    "lesson_path_item_1786576314228_072214e9": { # One real-world application (L2)
    ...
    "lesson_path_item_1786576315025_5bf29b44": { # Behavior-over-time graphs
    ...
    "lesson_path_item_1786576315268_ba489c33": { # Causal-loop diagrams
    ...
    "lesson_path_item_1786576315582_feb5ed55": { # Stock-and-flow diagrams
    ...
    "lesson_path_item_1786576315818_b68de4a0": { # Basic simulation
    ...
    "lesson_path_item_1786576316146_affe1d44": { # Model assumptions
    ...
    "lesson_path_item_1786576316402_44a0e5be": { # Calibration and validation
    ...
    "lesson_path_item_1786576316705_8135908a": { # Boundary criticism
    ...
    "lesson_path_item_1786576316936_fc843a38": { # Sensitivity analysis
    ...
    "lesson_path_item_1786576318426_b0a90d3c": { # Modeling exercise (L3)
    ...
    "lesson_path_item_1786576318663_9f5b0701": { # One real-world application (L3)
    ...
    "lesson_path_item_1786576319589_e755d5de": { # Where intervention actually works
    ...
    "lesson_path_item_1786576319853_d4716879": { # Why obvious solutions often fail
    ...
    "lesson_path_item_1786576320223_895dbf12": { # Delayed consequences
    ...
    "lesson_path_item_1786576320494_51eaf469": { # Unintended side effects
    ...
    "lesson_path_item_1786576320869_353c6d45": { # Incentive redesign
    ...
    "lesson_path_item_1786576321169_31694f49": { # Rules and information flows
    ...
    "lesson_path_item_1786576321667_240c26bc": { # Changing goals and paradigms
    ...
    "lesson_path_item_1786576321934_f068ea76": { # Policy resistance (L4)
    ...
    "lesson_path_item_1786576323593_0f696701": { # Modeling exercise (L4 Slot 1)
    ...
    "lesson_path_item_1786576323864_c1f27d27": { # One real-world application (L4 Slot 1)
    ...
    "lesson_path_item_1786576366051_e80eaaab": { # Modeling exercise (L4 Slot 2)
    ...
    "lesson_path_item_1786576366484_8ef1b40c": { # One real-world application (L4 Slot 2)
    ...
    "lesson_path_item_1786576324968_1caf4211": { # Business and cash flow
    ...
    "lesson_path_item_1786576325273_e3e3bc41": { # Learning Compass
    ...
    "lesson_path_item_1786576325702_5bafd840": { # Personal productivity
    ...
    "lesson_path_item_1786576326008_5b11cc33": { # Organizations and power
    ...
    "lesson_path_item_1786576326447_aebf0a80": { # Relationships and small groups
    ...
    "lesson_path_item_1786576326761_68ed7c46": { # Markets
    ...
    "lesson_path_item_1786576327189_daa99885": { # Technology systems
    ...
    "lesson_path_item_1786576327493_92a0bef2": { # Public policy
    ...
    "lesson_path_item_1786576329384_a3a355d3": { # Modeling exercise (L5)
    ...
    "lesson_path_item_1786576329677_83c961a4": { # One real-world application (L5)
    ...
    # --- LEVEL 6: Advanced Direction (11 lessons) ---
    "lesson_path_item_1786576330865_b53aef81": { # Formal system dynamics
    ...
    "lesson_path_item_1786576331187_128a9140": { # Complex adaptive systems
    ...
    "lesson_path_item_1786576331709_5fdd3920": { # Viable systems
    ...
    "lesson_path_item_1786576332029_51a154cf": { # Cybernetics
    ...
    "lesson_path_item_1786576332497_9217dc56": { # Network science
    ...
    "lesson_path_item_1786576332821_4a56f9e8": { # Agent-based modeling
    ...
    "lesson_path_item_1786576333310_387d9582": { # Resilience and systemic risk
    ...
    "lesson_path_item_1786576333645_cc5639ee": { # Organizational learning
    ...
    "lesson_path_item_1786576334104_02b8376f": { # Systems intervention ethics
    ...
    "lesson_path_item_1786576336128_c9d2e52a": { # Modeling exercise (L6)
    ...
    "lesson_path_item_1786576336593_5a114646": { # One real-world application (L6)
...
# Execute PATCH for all 71 lessons
success = 0
for idx, (lid, content) in enumerate(lesson_content.items()):
    current_status = lessons_meta[lid]['status']
    patch_body = {
    ...
    try:
        ...
        success += 1
        print(f"[{idx+1:02d}/71] Updated {lessons_meta[lid]['title']} ({lid}) -> OK")
    except Exception as e:
        print(f"[{idx+1:02d}/71] FAILED {lid}: {e}")

print(f"\nCompleted: {success}/71 lessons updated successfully")
