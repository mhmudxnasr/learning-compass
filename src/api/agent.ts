...
const CAPABILITIES = [
  ...
  ['POST', '/learning/srs/review', 'Record a learner-confirmed recall grade and update its schedule/evidence.'],
  ...
  ['PATCH', '/learning/core/threads/:id/stages/:stageId', 'Edit a Learning Thread stage definition and order; lifecycle status is managed by start/verify commands.'],
