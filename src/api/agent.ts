...
const CAPABILITIES = [
  ...
  ['GET', '/recommendations/books', 'Read the separate Books shelf, including book-scoped chapter metadata and file links.'],
  ...
  ['GET', '/notes/hub', 'Read notes owned by a Learning Hub path (thread_id) or stage (stage_id).'],
  ...
  ['GET', '/learning/core/threads/:id/path', 'Read one complete Learning Hub path with stages, work items, sources, requirements, and evidence.'],
  ...
  ['POST', '/learning/core/threads', 'Create a purpose-first Learning Thread with evidence requirements; deep Hub paths must include an interview brief in the Thread context.'],
  ...
  ['PATCH', '/learning/core/threads/:id/stages/:stageId', 'Update a Learning Hub stage status or definition.'],
  ['POST', '/learning/core/threads/:id/stages/:stageId/items', 'Add a required concept, recall prompt, exercise, application, or reflection to a Learning Hub stage.'],
  ['PATCH', '/learning/core/threads/:id/stages/:stageId/items/:itemId', 'Mark a Learning Hub work item open, satisfied, or waived, or edit its definition.'],
  ...
  ['GET', '/artifacts/hub', 'Read file metadata owned by a Learning Hub path (thread_id) or stage (stage_id).'],
