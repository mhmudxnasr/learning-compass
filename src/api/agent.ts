...
const CAPABILITIES = [
  ...
  ['GET', '/compass/pick', 'Read the single unresolved Personal Bayesian Cascade pick.'],
  ['POST', '/compass/picks', 'Submit 3–8 candidates for server-owned adaptive Compass Pick selection.'],
  ['POST', '/compass/pick/:id/start', 'Start the one Compass Pick through the normal Queue/session workflow.'],
