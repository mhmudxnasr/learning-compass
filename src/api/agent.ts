...
const CAPABILITIES = [
  ...
  [
    'PATCH',
    '/capture/personal/:id',
    'Edit personal library metadata, progress, status, rating, tags, note, link, or branch while retaining canonical identity and event lineage.',
  ],
  [
    'POST',
    '/assistant/interpret',
  ...
  [
    ...
    'Replace the preferred Original source URL while preserving the previous archive URL.',
  ],
  [
    'PATCH',
  ...
  [
    ...
    'Assign a source to an existing Learning Hub stage with a foundation, case, companion, counterevidence, or reference role; source-fill work preserves the path structure.',
  ],
  [
    'POST',
  ...
  [
    ...
    'Attach one verified study source directly to a course lesson.',
  ],
  [
    'PATCH',
