...
const CAPABILITIES = [
  ...
  ['PATCH', '/capture/personal/:id', 'Edit personal library metadata, progress, status, rating, tags, note, or branch while retaining canonical identity and event lineage; canonical links use guarded source replacement.'],
  ...
  ['PATCH', '/recommendations/:id/source-url', 'Replace the preferred Original source URL with the observed current URL as a required precondition while preserving the previous archive URL.'],
  ['GET', '/recommendations/:id/source-health', 'Read the latest advisory source-health projection, bounded attempts, and guarded URL replacement lineage.'],
  ['POST', '/recommendations/:id/source-health/check', 'Explicitly verify and persist the current Original URL without rewriting it.'],
  ['POST', '/recommendations/:id/source-url/verify', 'Verify and persist one replacement candidate against the observed current URL without installing it.'],
  ...
  ['GET', '/learning/srs/repair', 'Read cards that crossed the transparent lapse threshold, with review history, repair history, provenance, and comparison candidates.'],
  ...
  ['PUT', '/learning/srs/cards/:id', 'Learner-edit a recall card; wording preserves scheduling while a semantic revision explicitly resets it.'],
  ['POST', '/learning/srs/cards/:id/status', 'Pause, resume, retire, or restore one recall card while preserving scheduling and history.'],
  ...
  ['GET', '/learning/core/threads/:id/material-sources', 'Search existing branch-owned Library sources and read their current Thread, Level, and Lesson placements before attaching material.'],
  ...
  ['PATCH', '/learning/core/threads/:id/sources/:sourceId', 'Edit one exact Thread source role, contribution, or order without changing progression.'],
  ...
  ['POST', '/learning/core/threads/:id/stages/:stageId/sources', 'Attach one existing branch-owned Library source to an exact Level with a primary, case, challenge, reference, or optional role.'],
  ['PATCH', '/learning/core/threads/:id/stages/:stageId/sources/:sourceId', 'Edit one exact Level source role, contribution, requirement, or order without changing progression.'],
  ['DELETE', '/learning/core/threads/:id/stages/:stageId/sources/:sourceId', 'Remove one exact Level source placement without deleting the Library source.'],
  ...
  ['POST', '/learning/core/threads/:id/lessons/:lessonId/sources', 'Attach one existing branch-owned Library source directly to an exact lesson.'],
  ['PATCH', '/learning/core/threads/:id/lessons/:lessonId/sources/:sourceId', 'Edit one exact lesson source role, contribution, or order without changing progression.'],
  ['DELETE', '/learning/core/threads/:id/lessons/:lessonId/sources/:sourceId', 'Remove one exact lesson source placement without deleting the Library source.'],
  ['GET', '/learning/core/threads/:id/lessons/:lessonId/material-request', 'Read the latest explicit Find material job for one exact lesson.'],
  ['POST', '/learning/core/threads/:id/lessons/:lessonId/material-request', 'Explicitly request Library-first material research for an empty current-Level lesson; the worker may abstain and cannot attach, Queue, start, or advance anything.'],
  ...
  ['GET', '/annotations/resolve', 'Resolve a shared public URL to an existing branch-owned source before anchor creation.'],
