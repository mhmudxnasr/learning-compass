    ...
    <div class="settings-page preferences-page">
      <header class="settings-intro preferences-hero">
        <div class="preferences-hero-copy">
          <span class="settings-active-label">Personal settings</span>
          <h1>Preferences</h1>
          <p>
            Make the studio feel right, then decide what it may prepare for you. Changes are immediate and apply
            everywhere.
          </p>
        </div>
      ...
      <section class="settings-active-system" aria-label="Active visual system">
        ...
        <div class="preferences-active-copy">
          <span class="settings-active-label">Current appearance</span>
          <strong>{activePreset?.name || 'Custom tuning'}</strong>
          <small>
            {activeThemeName} · {activeFontPreset?.name || (font === 'custom' ? 'Custom font stacks' : font)} ·{' '}
            {effectiveBaseSize}px type · {density} spacing
          </small>
        </div>
        <span class="preferences-active-scope">
          <strong>Global</strong>
          <small>Home through Settings</small>
        </span>
      </section>

      <div class="preferences-layout">
        <aside class="preferences-index" aria-label="Preference sections">
          <div class="preferences-index-heading">
          ...
          <div class="preferences-index-note">
            <strong>One system, everywhere</strong>
            <p>Appearance choices update every workspace, object view, and dialog.</p>
          </div>
        </aside>
