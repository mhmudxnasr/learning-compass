...
function ThemeSemanticPreview({ palette, mode }: { palette: CustomPalette; mode: ThemeMode }) {
  ...
  return (
    <span class="theme-semantic-preview" style={previewStyle as any} aria-hidden="true">
          ...
          <section class="visual-presets-section" aria-labelledby="visual-presets-title" id="visual-presets-heading">
            <div class="section-head">
              <div>
                ...
                <h2 id="visual-presets-title">Start with a complete workspace</h2>
                <p class="section-description">
                  One choice sets the color, type, spacing, and shape together. Fine-tune anything below.
                </p>
              </div>
            ...
            <div class="visual-presets-grid">
              {VISUAL_PRESETS.map((preset) => {
                ...
                return (
                  ...
                  >
                    <span class="visual-preset-swatch" aria-hidden="true">
                      {themePreset?.swatches.map((color) => (
                    ...
                    <span class="visual-preset-copy">
                      ...
                      <em>
                        {fontPreset?.name} · {preset.typography.baseSize}px · {preset.display.fontSize}
                      </em>
                    </span>
                  </button>
                )
