  ...
  return <div class="folio-home-workspace">
    ...
    <section class="folio-home-focus" aria-labelledby="home-focus-title">
      <div class="folio-home-focus-copy">
        ...
        </> : <Empty title="The working shelf is clear" body="Capture a source to Inbox, then curate it when you are ready to make a deliberate commitment." action={<button type="button" class="folio-button folio-button-primary" onClick={() => onCapture ? onCapture() : navigate(routeHref('library', 'triage', 'inbox'), onNavigate)}>Capture a source</button>}/>}
      </div>
    </section>
