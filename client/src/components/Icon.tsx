...
const paths: Record<IconName, ComponentChildren> = {
  ...
  learn: (
    <>
      ...
      <path d="M7 11v5c2.8 2.1 7.2 2.1 10 0v-5M21 9v6" />
    </>
  ),
  map: (
    <>
      ...
      <path d="m8 6 8-.7M7 8l4 9m6-10-4 10" />
    </>
  ),
  settings: (
    <>
  ...
  path: (
    <>
      ...
      <path d="m6.5 16.7 4.2-8.9m2.7 0 4.3 7.5" />
    </>
  ),
  branch: (
    <>
      <path d="M6 4v16M6 9h5a4 4 0 0 0 4-4V4M6 15h5a4 4 0 0 1 4 4v1" />
    </>
  ),
  balance: (
    <>
  ...
  sync: (
    <>
      ...
      <path d="M18.4 5.6A8 8 0 0 0 5 9m.6 9.4A8 8 0 0 0 19 15" />
    </>
  ),
  ...
  pin: (
    <>
      <path d="M12 17v5M7 3h10l-2 5 3 3H6l3-3z" />
    </>
  ),
  spark: (
    <>
  ...
  palette: (
    <>
      <path d="M12 2a10 10 0 1 0 10 10c0-1.5-1-2-2-2h-2a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.5A2.5 2.5 0 0 0 21 3.5 10 10 0 0 0 12 2Z" />
  ...
  warning: (
    <>
      <path d="m10.29 3.86-8.6 14.9A1.73 1.73 0 0 0 3.2 21.4h17.6a1.73 1.73 0 0 0 1.5-2.64l-8.6-14.9a1.73 1.73 0 0 0-3.01 0z" />
