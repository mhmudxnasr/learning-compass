...
export const THEME_PRESETS: ThemePreset[] = [
  {
    ...
    description: 'Linear-inspired graphite planes, cool white type, and a restrained periwinkle command signal.',
    mode: 'dark',
    swatches: ['#8a7cff', '#0c0d10', '#232331', '#a7a7b4'],
    ink: '#f4f4f5',
    surface: '#15161b',
    rail: '#07080a',
    seam: '#2a2b32',
...
export const THEME_VARIANTS: Array<{ name: string; day: CustomPalette; night: CustomPalette }> = [
  { name: 'Linear', day: { brand: '#6558D3', shell: '#F3F3F1', surface: '#FFFFFF', highlight: '#E7E4FA', accent: '#565963', ink: '#202124', rail: '#E8E8E5', seam: '#D4D4D0', due: '#8A641C', danger: '#A23D45', map: '#3C6E91' }, night: { brand: '#8A7CFF', shell: '#0C0D10', surface: '#15161B', highlight: '#232331', accent: '#A7A7B4', ink: '#F4F4F5', rail: '#07080A', seam: '#2A2B32', due: '#D8A657', danger: '#EE6B76', map: '#62B5D4' } },
...
export const VISUAL_PRESETS: VisualPreset[] = [
  {
    id: 'continuum',
    name: 'Continuum',
    description: 'Linear-style graphite, restrained periwinkle commands, and balanced console rhythm.',
    inspiration: 'Inspired by Linear',
    theme: 'continuum',
    font: 'studio',
    typography: { ...DEFAULT_TYPOGRAPHY, baseSize: 16, bodyWeight: 400, headingWeight: 600, lineHeight: 1.56, letterSpacing: -0.005, readingMeasure: 70 },
    display: { density: 'balanced', radius: 'soft', fontSize: 'medium' },
  },
  {
    id: 'raycast-command',
