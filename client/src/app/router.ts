...
export function itemHref(item: { id?: string | number; recommendation_id?: string | number; book_id?: string | number; content_type?: string | null; item_type?: string | null; is_book_chapter?: boolean }, section?: string) {
