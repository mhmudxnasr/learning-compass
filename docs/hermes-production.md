...
4. Inspect the remote D1 migration ledger. Migrations through `0075_riyadh_legacy_pair_visibility.sql` are applied; require exact repository parity and never replay applied migrations.
