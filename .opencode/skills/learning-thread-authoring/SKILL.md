...
Load and follow the canonical Hermes skill:

`/home/mahmud/.hermes/skills/learning/learning-thread-authoring/SKILL.md`

This project skill exists only to make the canonical Hermes procedure discoverable in OpenCode. Do not duplicate or override its workflow here.
