...
**Production Worker version:** `ec86a4c1-dfe5-4d47-b705-f71ce7ec598f`

Production D1 migrations are applied through `0023_intelligence_v2.sql`.

## Latest Audit

- **Navigation rail clarified** (2026-08-11): destination-specific icons now distinguish Momentum, Inbox, Files, Notes, Activity, Queue, and Atlas; Activity replaces Recall in the primary rail and mobile navigation; Queue sits directly before Atlas; Profile remains available beside Search and Settings; the header now uses a premium minimal compass mark served through explicit SVG asset routes. Build, E2E, and `git diff --check` passed locally. Not deployed yet.
